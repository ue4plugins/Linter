...
struct FBPFunctionPointers {
    ...
    FBPFunctionPointers() :
        FunctionEntryNode{nullptr},
        FunctionResultNode{nullptr} {}
...
public:
    enum EResult {
        Cancel = 0,
        // No/Cancel, normal usage would stop the current action
        Confirm = 1,
        // Yes/Ok/Etc, normal usage would continue with action
    };
